...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('softdelete_softdeleterecord', (
            ...
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recordsets',
                                                                                to=orm['softdelete.ChangeSet'])),
    ...
    models = {
        ...
        'softdelete.softdeleterecord': {
            ...
            'changeset': ('django.db.models.fields.related.ForeignKey', [],
                          {'related_name': "'recordsets'", 'to': "orm['softdelete.ChangeSet']"}),
            'content_type': (
            'django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
