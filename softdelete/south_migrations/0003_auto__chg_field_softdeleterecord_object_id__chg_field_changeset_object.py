...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'softdelete_softdeleterecord', 'object_id',
                        self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ChangeSet.object_id'
        db.alter_column(u'softdelete_changeset', 'object_id',
                        self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'softdelete.softdeleterecord': {
            'Meta': {'unique_together': "(('changeset', 'content_type', 'object_id'),)",
                     'object_name': 'SoftDeleteRecord'},
            'changeset': ('django.db.models.fields.related.ForeignKey', [],
                          {'related_name': "'soft_delete_records'", 'to': u"orm['softdelete.ChangeSet']"}),
            'content_type': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
